...
@Mod(modid = ExampleAddon.MOD_ID, name = "Ponder Example Addon", version = "1.1.2",
    dependencies = "required-after:forge@[14.23.5.2847,);required-after:ponder_legacy@[1.1.2-mc1.12.2]")
