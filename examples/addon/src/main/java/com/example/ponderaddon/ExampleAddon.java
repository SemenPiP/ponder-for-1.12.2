...
@Mod(modid = ExampleAddon.MOD_ID, name = "Ponder Example Addon", version = "1.0.3",
    dependencies = "required-after:forge@[14.23.5.2847,);required-after:ponder@[1.0.3-mc1.12.2]")
